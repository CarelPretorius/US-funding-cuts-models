...
xnames = {'r_beta','rf_beta_mdr','r_sym', 'p_pu','r_cs','rf_cs2', 'rf_mort_TB','p_Dx','p_Tx_complete','p_MDRrec2019', 'r_MDR_acqu','rf_self_cure', 'rf_progression', 'rf_reactivation','rf_relapse',  'rf_p_imm'}; %, 'rf_LTBI_stabil',
...
% Country 3
data.inc2023  = [220,361,537];    % Annual incidence rate 2023
data.mdr2019  = [7.4 13 19];      % RR TB in 2019
data.mdr2023  = [6.9  12  18];    % RR TB in 2023
data.noti2023 = 347*[0.75 1 1.25];% Annual notification rate 2023
data.mdriniTX = 4.75*[0.5 1 1.5]; % Started second line treatment
data.mort     = [4.7 13 25];      % Annual mortality rate 2023
