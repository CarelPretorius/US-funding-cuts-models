...
% Country 1 
data.inc2023 = [164 195  228];     % Annual incidence rate 2023
data.mdr2019 = [6.7 8.2 9.7];      % RR TB in 2019
data.mdr2023 = [5.7  7.4  9.1];    % RR TB in 2023
data.noti2023 = 175*[0.75 1 1.25]; % Annual notification rate 2023
data.mdriniTX = 3.45*[0.5 1 1.5];  % Started second line treatment
data.mort    = [16 22 30];         % Annual mortality rate 2023
